...
public class tp1 {
    ...
    public void trouverlivres() {
        ...
        driver.findElement(By.cssSelector("ul.hmenu-visible > li:nth-child(3)")).click(); // child car tous les élemes ont le mm id


    }

    @Test
    public void testMultiplelement() {
        WebElement barreRechere = driver.findElement(By.id("twotabsearchtextbox"));//id // on a ajouter webelement
        barreRechere.sendKeys("machine a raclette"+ Keys.ENTER);

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-component-type='s-search-result']")));


        List<WebElement> listDeResultat = driver.findElements(By.cssSelector("[data-component-type='s-search-result']"));
        listDeResultat.get(0).click();
